...
def convertir_de_euros_a_yen_japones():
    ...
    ui.label_resultado.setText("en euros: " + "{:.2f}".format(yen_japones).replace(".",","))
...
def convertir_de_euros_a_pesos():
    ...
    ui.label_resultado.setText("en euros: " + "{:.2f}".format(pesos).replace(".",","))
...
def convertir_de_euros_a_libras():
    ...
    ui.label_resultado.setText("en euros: " + "{:.2f}".format(libras).replace(".",","))
...
def convertir_de_euros_a_dolar():
    ...
    ui.label_resultado.setText("en euros: " + "{:.2f}".format(dolar).replace(".",","))
...
def convertir_de_euros_a_franco_suizo():
    ...
    ui.label_resultado.setText("en euros: " + "{:.2f}".format(franco_suizo).replace(".",","))
